    ...
    def getObjectForCRUD(self, raw_data, obj_name, isUpToServer):
        ...
        if obj_name == 'fleet.vehicle':
            return {
                ...
                'state_id': None if not raw_data.get('state_id') else vehicle_state_env.search([('id', '=', raw_data.get('state_id'))]).ex_id if isUpToServer else vehicle_state_env.search([('ex_id', '=', raw_data.get('state_id'))]).id,
                ...
                'driver_id': None if not raw_data.get('driver_id') else res_partner_env.search([('id', '=', raw_data.get('driver_id'))]).ex_id if isUpToServer else res_partner_env.search([('ex_id', '=', raw_data.get('driver_id'))]).id,
                ...
                'category_id': None if not raw_data.get('category_id') else vehicle_category_env.search([('id', '=', raw_data.get('category_id'))]).ex_id if isUpToServer else vehicle_category_env.search([('ex_id', '=', raw_data.get('category_id'))]).id,

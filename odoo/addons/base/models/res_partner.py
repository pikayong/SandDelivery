...
class Partner(models.Model):
    ...
    parent_id = fields.Many2one('res.partner', string='Related Company', index=True, readonly=True)
    ...
    company_registry = fields.Char(string="Company ID", compute='_compute_company_registry', store=True, readonly=True,
    ...
    category_id = fields.Many2many('res.partner.category', column1='partner_id',
                                    column2='category_id', string='Tags', default=_default_category, readonly=True)
    ...
    company_type = fields.Selection(string='Company Type',
        ...
        compute='_compute_company_type', inverse='_write_company_type', default="person", readonly=True)
